...
namespace DefaultContactListTypes 
{
	const std::string
				K_DEFAULT_ALLOWED =		"AL",
				K_DEFAULT_BLOCKED =		"BL"
				;
}
...
namespace ProtocolConstants
{
	...
	const std::string
				...
				K_PROTOCOL_VERSION =				"MSNP11",//"MSNP12",
	...
	const std::string
					K_PAYLOAD_COMMANDS[] = {"PAG", "NOT", "MSG", "UBX"}
				;
};
...
namespace NotificationMessages
{
	const std::string
			...
			K_DEFAULT_CONTACT_LIST_MSG		= "BLP",
			K_PHONE_NUMBERS					= "PRP",
			K_GROUP_LIST_MSG				= "LSG",
			K_CONTACT_LIST_MSG				= "LST",
			K_CONTACT_PHONE_NUMBERS			= "BPR",
